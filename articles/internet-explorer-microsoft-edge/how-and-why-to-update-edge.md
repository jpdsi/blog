...
なお、Edge の更新用モジュールである MicrosoftEdgeUpdate.exe はこれまで UpdateDefault を 0 にしていた場合 Edge ブラウザだけではなく WebView2 の更新も抑止することが可能でしたが、1.3.171.39 以降は UpdateDefault を 0 に設定していてもWebView2 の更新は抑止されなくなりました。
